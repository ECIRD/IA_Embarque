# -*- coding: utf-8 -*-
"""
Created on Mon Feb 24 10:20:37 2025
...
def synchronise_UART(serial_port):
    ...
    Returns:
        None
    """
    print("Début de la synchronisation en UART")
    while (1):
        serial_port.write(b"\xAB")
        ret = serial_port.read(1)
        print("lecture fini 1")
        print(ret)
        if (ret == b"\xCD"):
            serial_port.read(1)
            print("lecture fini 2")
            break
    print("Synchornisation terminé")
...
def send_inputs_to_STM32(inputs, serial_port):
    ...
    Returns:
        None
    """
    print("Début de l'écriture:", inputs)

/**
  ...
  ******************************************************************************
  */
#ifndef AI_MODEL_V1_H
#define AI_MODEL_V1_H

#include "model_v1_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_MODEL_V1_MODEL_NAME          "model_v1"
#define AI_MODEL_V1_ORIGIN_MODEL_NAME   "model_v1"

/******************************************************************************/
#define AI_MODEL_V1_ACTIVATIONS_ALIGNMENT   (4)
#define AI_MODEL_V1_INPUTS_IN_ACTIVATIONS   (4)
#define AI_MODEL_V1_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_MODEL_V1_IN_NUM        (1)

AI_DEPRECATED
#define AI_MODEL_V1_IN \
  ai_model_v1_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_MODEL_V1_IN_SIZE { \
  AI_MODEL_V1_IN_1_SIZE, \
}
#define AI_MODEL_V1_IN_SIZE_BYTES { \
  AI_MODEL_V1_IN_1_SIZE_BYTES, \
}
#define AI_MODEL_V1_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MODEL_V1_IN_1_CHANNEL     (5)
#define AI_MODEL_V1_IN_1_SIZE        (5)
#define AI_MODEL_V1_IN_1_SIZE_BYTES  (20)

/******************************************************************************/
#define AI_MODEL_V1_OUT_NUM       (1)

AI_DEPRECATED
#define AI_MODEL_V1_OUT \
  ai_model_v1_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_MODEL_V1_OUT_SIZE { \
  AI_MODEL_V1_OUT_1_SIZE, \
}
#define AI_MODEL_V1_OUT_SIZE_BYTES { \
  AI_MODEL_V1_OUT_1_SIZE_BYTES, \
}
#define AI_MODEL_V1_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MODEL_V1_OUT_1_CHANNEL     (5)
#define AI_MODEL_V1_OUT_1_SIZE        (5)
#define AI_MODEL_V1_OUT_1_SIZE_BYTES  (20)

/******************************************************************************/
#define AI_MODEL_V1_N_NODES (8)
 ...
 * @ref ai_model_v1_create. Both the activations memory buffer 
 ...
 * using @ref ai_model_v1_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_model_v1_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_model_v1_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_MODEL_V1_*
 * defines into file @ref model_v1.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
